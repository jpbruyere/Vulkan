...
void VulkanExampleBase::setupDepthStencil()
{
    ...
    depthStencil = new vks::Image(vulkanDevice, VK_IMAGE_TYPE_2D, depthFormat, width, height,
...
{
    renderPass = vks::tools::createRenderPass (device, swapChain.colorFormat, depthFormat, VK_ATTACHMENT_LOAD_OP_CLEAR, sampleCount);
}
